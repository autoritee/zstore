        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <?php $totalbelanja = 0; ?>
                    ...
                    <!-- meampilkan produk yang sedang diperulangkan berdasarkan id_produk -->
                    <?php
         ...
         <form method="post">
             ...
             <div class="form-group">
              ...
              <textarea class="form-control" name="alamat" placeholder="mohon memasukan alamat lengkap pengiriman"></textarea>
             </div>
         ...
         if (isset($_POST["checkout"]))
         {
           ...
           // mendapatkan id_produk barusan terjadi
